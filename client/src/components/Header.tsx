          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              <a
                ...
                className="nav-link hover:text-pink-shock transition-colors"
                aria-label="Falar no Instagram @euinelegivel"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="nav-link hover:text-lime-acid transition-colors"
                aria-label="Seguir no TikTok @euinelegivel"
              >
                <TikTokIcon size={18} />
              </a>
              <button
