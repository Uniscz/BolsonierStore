      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              { color: 'Preto', image: '/manus-storage/preto_0_5670725_22793c3e.png' },
              { color: 'Branco', image: '/manus-storage/branco_1_5670725_87309e54.png' },
              { color: 'Azul Royal', image: '/manus-storage/azul-royal_3_5670725_71912610.png' },
              { color: 'Verde Bandeira', image: '/manus-storage/verde-bandeira_4_5670725_00d6ab28.png' },
              { color: 'Amarelo Canário', image: '/manus-storage/amarelo-canario_2_5670725_66996668.png' },
            ].map((product) => (
